...
- 2 セクション = **生徒の様子** / **情報共有**。上部に共通の投稿日 期間フィルタ (今週/先週/今月/先月/カスタム)。
- 種別 = `journal_entries` の kind 直値 **続けたい (keep) / 気になる (concern) / 感謝 (thanks) / たすけて (help)**。役に立つ情報箱は「なるほど」リアクション付き投稿の自動集計。
